...
// (الألواح في يومية الألواح). الإكسسوارات والنقل الداخلي ومصاريف الدهانات والليد بيدخلوا هنا.
export const FACTORY_EXPENSE_TYPES = ['شراء إكسسوارات', 'نثريات', 'أجور عمال', 'نقل داخلي', 'مصاريف دهانات', 'مصاريف ليد'] as const;
