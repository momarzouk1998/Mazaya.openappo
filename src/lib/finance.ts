...
// ============================================================
// يومية المصنع (محفظة المصنع): بتشمل كل المصروفات ما عدا المشتريات
// (المشتريات دي بتتبع يومية الألواح). أجور عمال ونثريات بيدخلوا فيها.
export const FACTORY_EXPENSE_TYPES = ['نثريات', 'أجور عمال'] as const;

// يومية الألواح: بتحسب المشتريات فقط (ألواح + إكسسوارات).
// التمريري بيدخل فيها كمان (لأن العميل قاله: "ضيف هنا التحويل التمريري").
