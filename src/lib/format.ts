...
export const ENTRY_TYPE_LABELS: Record<string, string> = {
  ...
  "أجور عمال": "أجور عمال",
  "نقل داخلي": "نقل داخلي",
  "مصاريف دهانات": "مصاريف دهانات",
  "دهانات": "مصاريف دهانات",
  "مصاريف ليد": "مصاريف ليد",
  "ليد": "مصاريف ليد",
  "مصاريف طريق": "مصاريف طريق",
  "مصاريف الطريق": "مصاريف طريق",
  "أعمال خارجية": "أعمال خارجية",
};
...
export const ENTRY_TYPE_COLORS: Record<string, string> = {
  ...
  "شراء إكسسوارات": "bg-rose-100 text-rose-700 border-rose-300",
  ...
  "نقل داخلي": "bg-cyan-100 text-cyan-700 border-cyan-300",
  "مصاريف دهانات": "bg-fuchsia-100 text-fuchsia-700 border-fuchsia-300",
  "دهانات": "bg-fuchsia-100 text-fuchsia-700 border-fuchsia-300",
  "مصاريف ليد": "bg-yellow-100 text-yellow-800 border-yellow-300",
  "ليد": "bg-yellow-100 text-yellow-800 border-yellow-300",
  "مصاريف طريق": "bg-sky-100 text-sky-700 border-sky-300",
  "مصاريف الطريق": "bg-sky-100 text-sky-700 border-sky-300",
  "أعمال خارجية": "bg-indigo-100 text-indigo-700 border-indigo-300",
