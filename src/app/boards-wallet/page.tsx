              ...
              <tbody className="divide-y">
                {day.entries.map((e) => (
                  <tr key={e.id}>
                    ...
                    <td className={`p-2 font-bold ${e.entry_type === "تحويل تمريري" && e.party_type === "branch" ? "text-green-600" : "text-red-600"}`}>
...
export default function BoardsWalletPage() {
  ...
  return (
    <DashboardLayout profile={profile}>
      <PageHeader
        title="يومية الألواح"
        subtitle="مشتريات الألواح والإكسسوارات + التحويل التمريري"
        helpTitle="يومية الألواح"
        helpDescription="بتحسب المشتريات (ألواح + إكسسوارات) والتحويل التمريري (الوارد والصادر). التمريري بيدخل هنا كامل."
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <div className="card bg-white border-r-4 border-green-400">
            ...
            <div className="text-xs text-green-500/70">تمريري وارد</div>
          </div>
          <div className="card bg-white border-r-4 border-red-400">
            ...
            <div className="text-xs text-red-400">مشتريات + تمريري صادر</div>
          </div>
