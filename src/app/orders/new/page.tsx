  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        setParentOrders((oRes.data as Order[]) || []);
    ...
    <DashboardLayout>
      <div className="max-w-4xl space-y-6">
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900">أوردر جديد</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <td className="px-3 py-2">
                          {mat.item_category === 'board' ? (
                            ...
                            >
                              ...
                              {accessories
                                .filter((a) => a.quantity_remaining > 0)
                                .map((a) => (
          ...
          <div className="flex gap-3 pt-2">
            ...
            >
              ...
              {loading ? 'جاري الحفظ...' : '💾 حفظ الأوردر'}
            </button>
            <Link
              href="/orders"
