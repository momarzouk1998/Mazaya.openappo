  ...
  const items = [
    {
      ...
      desc: "إضافة وتعديل حسابات الموظفين، الأدمن، وتحديد صلاحيات كل موديول",
      icon: "⚙️",
      color: "from-slate-700 to-gray-800",
      path: "/admin/users",
    },
    {
      title: "قوائم الاختيارات والخامات",
      desc: "تحديد أنواع خامات الألواح، أنواع الإكسسوارات، والأنواع المعيارية",
      icon: "🏷️",
  ...
  return (
    <DashboardLayout profile={profile}>
      <PageHeader
        ...
        subtitle="مجمع إعدادات وصلاحيات المستخدمين وقوائم الاختيارات"
      />
